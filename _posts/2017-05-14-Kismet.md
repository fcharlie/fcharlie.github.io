...
如果开发者需要支持 SHA-3 ，又要考虑提供库的稳定性，可以选择 [RHash](https://github.com/rhash/RHash) , CMake 3.8 开始使用 RHash 支持 SHA-3 [Utilities/cmlibrhash](https://gitlab.kitware.com/cmake/cmake/tree/master/Utilities/cmlibrhash)。
